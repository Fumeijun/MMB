...
public class BaseServiceImpl<T>implements BaseService<T> {
    ...
    @Autowired//自动装配OneToOneDao实现类的对象 ,名字对应实体类名
    protected OneToOneDao one4oneDao;
    ...
    protected void initBaseBaseDao() throws Exception{
        ...
        //转化为属性名（相关的Mapper子类的引用名）account accountDao
        ...
        //field.get(this)获取当前this的field字段的值。例如：account对象中，baseDao所指向的对象为其子类型accountMapper对象，子类型对象已被spring实例化于容器中
